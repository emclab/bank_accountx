...
module BankAccountx
  class ApplicationController < ActionController::Base
    ...
    helper_method :has_index_right?, :has_create_right?, :has_update_right?, :has_show_right?, :has_destroy_right?, 
                  :has_activate_right?, :yes_no_cn
    ...
    #allow to activate/deactivate a contract
